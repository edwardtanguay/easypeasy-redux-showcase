...
export const PageWelcome = () => {
	const { message, persisted, userLevel } = useTypedStoreState((state) => state.mainModel);
	...
	return (
		...
		<p>change user name: <input value={persisted.userName} className="w-[9rem] px-1" onChange={(e) => setUserName(e.target.value)}/></p>
		<hr/>
